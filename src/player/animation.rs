...
const OFFSETS: [[Vec2; 3]; 19] = [
    [vec2(-2.0, 3.0), vec2(-3.0, -5.0), vec2(5.0, -5.0)], // idle 1
    [vec2(-2.0, 4.0), vec2(-3.0, -4.0), vec2(5.0, -4.0)],
    [vec2(-2.0, 4.0), vec2(-3.0, -4.0), vec2(5.0, -4.0)],
    [vec2(-3.0, 3.0), vec2(-4.0, -5.0), vec2(4.0, -5.0)], // walk 1
    [vec2(-2.0, 4.0), vec2(-3.0, -4.0), vec2(5.0, -4.0)],
    [vec2(-2.0, 4.0), vec2(-3.0, -4.0), vec2(5.0, -4.0)],
    [vec2(-3.0, 4.0), vec2(-2.0, -4.0), vec2(4.0, -4.0)],
    [vec2(-3.0, 4.0), vec2(-3.0, -4.0), vec2(5.0, -4.0)],
    [vec2(-2.0, 4.0), vec2(-4.0, -4.0), vec2(4.0, -4.0)],
    [vec2(-2.0, 4.0), vec2(-3.0, -3.0), vec2(4.0, -4.0)],
    [vec2(-3.0, 4.0), vec2(-3.0, -4.0), vec2(4.0, -4.0)],
    [vec2(-2.0, 3.0), vec2(-3.0, -5.0), vec2(5.0, -5.0)], // crouch 1
    [vec2(-2.0, 2.0), vec2(-3.0, -6.0), vec2(5.0, -5.0)],
    [vec2(-2.0, 1.0), vec2(-3.0, -7.0), vec2(5.0, -6.0)],
    [vec2(-2.0, 0.0), vec2(-3.0, -7.0), vec2(5.0, -7.0)],
    [vec2(-2.0, 2.0), vec2(-3.0, -6.0), vec2(5.0, -5.0)], // jump 1
    [vec2(-2.0, 3.0), vec2(-3.0, -5.0), vec2(4.0, -5.0)],
    [vec2(-2.0, 4.0), vec2(-3.0, -4.0), vec2(4.0, -4.0)],
    [vec2(-2.0, 4.0), vec2(-3.0, -4.0), vec2(4.0, -3.0)],
];
