...
use crate::{
    ...
    player::{
        light::{despawn_angle_indicator, despawn_angle_increments_indicators, should_shoot_light, PlayerLightInventory},
...
impl Plugin for CrystalShardPlugin {
    fn build(&self, app: &mut App) {
        app.add_event::<ShardAnimationEvent>()
            ...
            .add_systems(
                Update,
                (despawn_angle_indicator, despawn_angle_increments_indicators, should_shoot_light::<false>)
